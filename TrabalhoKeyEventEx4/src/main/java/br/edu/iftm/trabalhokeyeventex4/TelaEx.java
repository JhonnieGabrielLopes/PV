...
public class TelaEx extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mover.setBackground(new java.awt.Color(0, 0, 0));
        mover.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        mover.setForeground(new java.awt.Color(255, 255, 255));
        mover.setText(" KeyEvent-KeyPressed ");
    ...
    private void panelPrincipalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_panelPrincipalKeyPressed
        int x = mover.getX(), y = mover.getY();
        switch (evt.getKeyCode()){
            case KeyEvent.VK_LEFT:
                mover.setLocation(x-5, y);
                break;
            case KeyEvent.VK_RIGHT:
                mover.setLocation(x+5, y);
                break;
            case KeyEvent.VK_UP:
                mover.setLocation(x, y-5);
                break;
